...
def salle_de_tresor(fichier: str) -> bool:
    """
    :param fichier: une chaîne de caractères de l'emplacement du fichier
    :return: True si le joueur gagne, False sinon
    """
    with open(fichier, 'r', encoding='utf-8') as file:  # récupère le dictionnaire qui est dans le fichier JSON
